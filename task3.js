...
function add(){
    let xstring = document.getElementById('number1').value;
    let x = parseInt(xstring);
    let ystring = document.getElementById('number2').value;
...
//that gets the values of two HTML form controls with IDs of addend1 and addend2. 
...
function copyInput() {
  ...
  const outputElement = document.getElementById("#addnumbers");
